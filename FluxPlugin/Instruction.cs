...
namespace ScriptWriter {
    public class Instruction : INotifyPropertyChanged {
        ...
        // Constructor for invalid instructions in scripts with errors.
        public Instruction(int errorCode)
        {
            Type = InstructionType.Other;
            Opcode = (byte)errorCode;
            Description = "A problem with the script data was detected.";
        }
