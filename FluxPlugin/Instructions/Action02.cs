...
namespace BattleScriptWriter.Instructions {
    class Action02 : Instruction {
        ...
        [Category("Editable Properties"), Description("The index of the targeting subroutine used to select the second actor (if applicable).")]
        public byte Actor2
        {
            get
            {
        ...
        [Category("Editable Properties"), Description("The index of the targeting subroutine used to select the third actor (if applicable).")]
        public byte Actor3
        {
            get
            {
        ...
        [Category("Editable Properties"), Description("The index of the targeting subroutine.")]
        ...
        [Category("Editable Properties"), Description("The index of the Tech to perform.")]
